...
#impersonation-banner {
    ...
    padding: 7px 18px; box-shadow: 0 2px 8px rgba(0,0,0,0.25); gap: 12px;
}
...
<div id="impersonation-banner">
    <div>
        &#127918;
        Impersonating: <strong><?php echo htmlspecialchars($_SESSION['first_name'] . ' ' . $_SESSION['last_name']); ?></strong>
        &nbsp;&middot;&nbsp;
        <?php echo htmlspecialchars(ucfirst($_SESSION['role'])); ?>
        &nbsp;&middot;&nbsp;
        ID: <?php echo htmlspecialchars($_SESSION['employee_id']); ?>
    </div>
    <div><a href="sysadmin_test.php">&#8592; Back to Test Panel</a></div>
</div>
<?php } else { ?>
<style>
#sysadmin-bar {
...
#sysadmin-bar a { color: #FF6200; text-decoration: none; font-weight: 700; }
